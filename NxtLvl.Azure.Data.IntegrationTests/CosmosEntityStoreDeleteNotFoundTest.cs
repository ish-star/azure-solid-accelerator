...
{
    [TestClass]
    public class CosmosEntityStoreDeleteNotFoundTest
    {
        ...
        [TestMethod]
        public async Task CosmosEntityStoreDelete_NotFound()
        {
            try
            {
                var notExpectedResult = await _cosmosEntityStore.DeleteAsync(_testEntity);
