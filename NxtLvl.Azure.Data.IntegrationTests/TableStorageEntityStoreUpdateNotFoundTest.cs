...
{
    [TestClass]
    public class TableStorageEntityStoreUpdateNotFoundTest
    {
        ...
        [TestMethod]
        public async Task TableStorageEntityStoreUpdate_NotFound()
        {
            try
            {
                _testEntity.ETag = "*";
                var notExpectedResult = await _tableStorageEntityStore.UpdateAsync(_testEntity);
